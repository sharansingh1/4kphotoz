          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <div className="p-8">
                ...
                <h3 className="text-xl font-accent font-semibold text-white mb-4">Logos</h3>
            ...
            <div className="group bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <div className="p-8">
                ...
                <h3 className="text-xl font-accent font-semibold text-white mb-4">Social Media Graphics</h3>
                <p className="text-white/70 font-body text-sm leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-accent font-semibold text-white mb-4">Discovery</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-accent font-semibold text-white mb-4">Concept</h3>
              <p className="text-white/70 font-body text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-accent font-semibold text-white mb-4">Refinement</h3>
              <p className="text-white/70 font-body text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-accent font-semibold text-white mb-4">Delivery</h3>
              <p className="text-white/70 font-body text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8">
              ...
              <h3 className="text-xl font-accent font-semibold text-white mb-4">Unlimited Revisions</h3>
            ...
            <div className="text-center p-8">
              ...
              <h3 className="text-xl font-accent font-semibold text-white mb-4">Creative Excellence</h3>
              <p className="text-white/70 font-body">
            ...
            <div className="text-center p-8">
              ...
              <h3 className="text-xl font-accent font-semibold text-white mb-4">Collaborative Process</h3>
              <p className="text-white/70 font-body">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 mb-12">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-white/70 font-body">
                <div className="text-center">
